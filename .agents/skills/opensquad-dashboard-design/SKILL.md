...
- Instruction: read `.Codex/skills/opensquad-dashboard-design/reference.md` if you need the asset catalog or code examples
...
3. Instruction: read `.Codex/skills/opensquad-dashboard-design/reference.md` for the asset catalog and code examples
...
- **Consult reference.md** (`.Codex/skills/opensquad-dashboard-design/reference.md`) for the full asset catalog, code examples, and detailed technical guidance during implementation
