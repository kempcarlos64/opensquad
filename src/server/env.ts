...
const envSchema = z.object({
  ...
  RESEARCH_MODEL: z.string().min(1).default("gpt-5.6-terra"),
  LLM_REAL_CALLS_ENABLED: booleanFromString,
  REELS_RESEARCH_ENABLED: booleanFromString,
  ...
  RESEARCH_INPUT_PRICE_PER_MILLION: z.coerce.number().min(0).default(0),
  RESEARCH_OUTPUT_PRICE_PER_MILLION: z.coerce.number().min(0).default(0),
